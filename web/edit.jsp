		  ...
		  <div id="main">
			  <fieldset>
			  	<legend>Cena</legend> <br>	
                                <table >
                                        <tr> <td>  B. Tanie </td><td> Od <input name="cena1min" id="cena1min" type="number" value="<%= session.getAttribute("cena1min") %>"> zł</td> <td> do <input name="cena1max" id="cena1max" type="number" value="<%= session.getAttribute("cena1min") %>"> zł</td> </tr>
			  		...
			  		<tr> <td>  	B. Drogie</td><td> Od <input name="cena5min" id="cena5min" type="number" value="<%= session.getAttribute("cena5min") %>"> zł</td><td>  do <input name="cena5max" id="cena5max" type="number" value="<%= session.getAttribute("cena5max") %>"> zł</td></tr>
                                </table>
                                                </fieldset>
		   </div>
		    <div id="main">
			  <fieldset>
			  	<legend>Metraż</legend>	<br>
                                <table>
			  			<tr> <td>B. Małe</td><td> Od <input name="metraz1min" id="metraz1min" type="number" value="<%= session.getAttribute("metraz1min") %>"> m<sup>2</sup></td><td> do <input name="metraz1max" id="metraz1max" type="number" value="<%= session.getAttribute("metraz1max") %>"> m<sup>2</sup> </td> </tr>
			  			...
			  			<tr> <td>B. Duże</td><td> Od <input name="metraz5min" id="metraz5min" type="number" value="<%= session.getAttribute("metraz5min") %>"> m<sup>2</sup></td><td> do <input name="metraz5max" id="metraz5max" type="number" value="<%= session.getAttribute("metraz5max") %>"> m<sup>2</sup></td> </tr>
			  </table>
                          </fieldset>
		   </div>
			  ...
			  <fieldset>
			  	<legend>Odległość od centrum</legend> <br> <table>	
			  			<tr> <td>B. Mała</td><td> Od <input name="odleglosc1min" id="odleglosc1min" type="number" value="<%= session.getAttribute("odleglosc1min") %>"> m </td><td>do <input name="odleglosc1max" id="odleglosc1max" type="number" value="<%= session.getAttribute("odleglosc1max") %>"> m </td> </tr>
			  			...
			  			<tr> <td>B. Duża</td><td> Od <input name="odleglosc5min" id="odleglosc5min" type="number" value="<%= session.getAttribute("odleglosc5min") %>"> m</td><td> do <input name="odleglosc5max" id="odleglosc5max" type="number" value="<%= session.getAttribute("odleglosc5max") %>"> m </td> </tr>
			 </table>  </fieldset>
		   </div>
